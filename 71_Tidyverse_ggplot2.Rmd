...
.center[<img src="https://camo.githubusercontent." width = 4000px>]
...
- `ggplot2` is a popular R package that extends R's visualization capabilities. It takes the hassle out of things like creating legends, mapping other variables to scales like color, or faceting plots
...
---
## The three basic components of ggplot2 graphics

- Data (in a long format) mapped to graphical elements 
...
| Aethetics  | aes() | How to map your columns on x, y axis, color, size, shape (aesthetics) |
| Geometries | geom_ | The geometric shapes that will represent the data                  |

``` text
data +   
aesthetic mappings of columns to plot coordinates +  
...
- Scales control the mapping between data values and visual properties (aesthetics) such as position, color, size, shape, and transparency

- Position Scales:
  - scale_x_continuous(), scale_y_continuous(): For continuous x/y axes
  - scale_x_discrete(), scale_y_discrete(): For discrete x and y axes
  - scale_x_date(), scale_y_date(): For date/time x and y axes

- Color Scales:
  - scale_color_continuous(), scale_fill_continuous(): For continuous color gradients
  - scale_color_discrete(), scale_fill_discrete(): For discrete color palettes
  - Predefined color scales like scale_color_brewer(), scale_fill_brewer() for ColorBrewer palettes

- Size Scales, Shape Scales, Transparency (Alpha) Scales:

.small[ https://CRAN.R-project.org/package=ggsci R package for Scientific Journal and Sci-Fi Themed Color Palettes ]
...
* Sometimes, one needs to create separate plots of subsets of data. These are called facets in ggplot2
...
Note the ranges of X axes are different
...
.small[ http://www.sthda.com/english/wiki/ggplot2-barplots-quick-start-guide-r-software-and-data-visualization ]
-->

---
## Update visual themes and labels
...
.small[ https://CRAN.R-project.org/package=cowplot ]
...
## Barplot (using stat identity)

```{r fig.height=4}
class_agg <- data.frame(table(mpg$class))
colnames(class_agg) <- c("class", "count")
...
ggsave(filename = "test.jpg", plot = p, width = 7, height = 10, 
       units = c("in"), dpi = 300)
```
...
- **Inkscape** - vector graphics editor. Works with Scalable Vector Graphics (SVG) format. Export in any format, at any resolution. https://inkscape.org
    - Note `svg` graphic device in R. `ggsave()` also saves graphs in `svg` format

- **GIMP** - raster graphics editor. Think Photoshop. https://www.gimp.org

https://daviesmediadesign.com/inkscape-vs-gimp-which-one-should-you-use/ 

---
## But wait... There's more

- https://gganimate.com - animated ggplots
- https://wilkelab.org/ggridges - ridgeline plots
- https://ggrepel.slowkow.com - nonoverlapping text labels
- https://ggobi.github.io/ggally - ggplot2 extension with pairwise plot, scatterplot, parallel coordinates plot, survival plot, network plots, and more.
